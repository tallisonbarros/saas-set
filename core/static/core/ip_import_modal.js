(function () {
  ...
  var modal = byId("ip-import-modal");
  var openButtons = Array.from(document.querySelectorAll("[data-ip-import-open]"));
  var closeButtons = Array.from(document.querySelectorAll("[data-ip-import-close]"));
  var form = modal ? modal.querySelector("[data-ip-import-form]") : null;
  var errorBox = modal ? modal.querySelector("[data-ip-import-error]") : null;
  var processing = modal ? modal.querySelector("[data-ip-import-processing]") : null;
  var submitButton = modal ? modal.querySelector("[data-ip-import-submit]") : null;
  var titleNode = modal ? modal.querySelector("[data-ip-import-title]") : null;
  var copyNode = modal ? modal.querySelector("[data-ip-import-copy]") : null;
  ...
  function setStepState(stepName, state, label) {
    var step = modal.querySelector('[data-ip-import-step="' + stepName + '"]');
    var status = modal.querySelector('[data-ip-import-step-status="' + stepName + '"]');
    if (!step) {
      return;
    }
